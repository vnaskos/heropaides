...
<?php get_header(); ?>
	...
	<script type="text/javascript" src="<?php echo esc_url(get_template_directory_uri()); ?>/js/contact-form.js"></script>
					...
					while (have_posts()) : the_post(); ?>
						...
						<form action="<?php the_permalink(); ?>" id="contactForm" method="post">
							...
							<ol class="forms">
								...
								<li class="textarea">
									<textarea name="comments" id="commentsText" rows="15" class="requiredField"><?php if(isset($_POST['comments'])) { if(function_exists('stripslashes')) { echo stripslashes($_POST['comments']); } else { echo $_POST['comments']; } } ?></textarea>
									<?php if($commentError != '') { ?>
