<?php get_header(); ?>
	...
	<section id="main-section" class="grid-65 page">
		<div class="grid-100 title">
			<h3><?php the_time("F"); ?>, <?php the_time("Y") ?></h3>
		</div>
		<div class="grid-100">
			<?php if ( have_posts() ) :
				while ( have_posts() ) : the_post(); ?>
					<article class="preview-box">
						...
						<nav>
							<p><?php the_date(); ?> | <?php the_category(', ') ?> | <?php the_author() ?> | <a href="<?php comments_link(); ?>"> <?php comments_number ('0','1','%'); ?> Comments</a></p>
						</nav>
						<div class="blog1ent-entry">
							<p> <?php the_excerpt(); ?></p>
						</div>
						<div class="read-more">
							<a href="<?php the_permalink(); ?>"title="<?php the_title(); ?>">more &raquo;</a>
						</div>
					</article>
				<?php endwhile; ?> 
